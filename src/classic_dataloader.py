...
dataset_path = "../datasets/MIL-Data-2002-Musk-Corel-Trec9-MATLAB"

name2file = {
    "musk1": "musk1norm_matlab.mat",
    "musk2": "musk2norm_matlab.mat",
    "fox": "fox_100x100_matlab.mat",
    "tiger": "tiger_100x100_matlab.mat",
    "elephant": "tiger_100x100_matlab.mat"
}

class ClassicBag:
    def __init__(self, name="musk1"):
